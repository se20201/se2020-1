...
def matlab_test_cot(): #调用九组func.py进行测试
    ...
    if (error_max > 1e-3):
        ...
        content8.set("matlab cot功能测试完成,误差:" + str(error_max))
    else:
...
def matlab_test_tan(): #调用九组func.py进行测试
    ...
    if (error_max > 1e-3):
        ...
        content7.set("matlab_tan功能测试完成,误差:"+str(error_max))
...
def matlab_test_cos(): #调用九组func.py进行测试
    ...
    if (error_max > 1e-3):
        # print("error_max:", error_max, "deg:", deg)
        # v.set('sin功能测试完成,误差大于0.001!')
        content6.set("matlab_cos功能测试完成,误差:"+str(error_max))
...
def matlab_test_sin(): #调用九组func.py进行测试
    ...
    if (error_max > 1e-3):
        # print("error_max:", error_max, "deg:", deg)
        # v.set('sin功能测试完成,误差大于0.001!')
        content5.set("matlab_sin功能测试完成,误差:"+str(error_max))
...
def test_cos(): #调用九组func.py进行测试
    ...
    if (error_max > 1e-3):
        # print("error_max:", error_max, "deg:", deg)
        #tkinter.messagebox.showwarning(title='出错了！', message='cos功能测试完成,误差大于0.001!')
        content2.set("cos功能测试完成,误差:" + str(error_max))
    else:
        content2.set("cos功能测试完成,误差:" + str(error_max))
        #tkinter.messagebox.showinfo(title='信息提示！', message='cos功能测试完成,误差不大于0.001!')
    # return error_max
...
def test_tan(): #调用九组func.py进行测试
    ...
    if (error_max > 1e-3):
        # print("error_max:", error_max, "deg:", deg)
        #tkinter.messagebox.showwarning(title='出错了！', message='tan功能测试完成,误差大于0.001!')
        content3.set("tan功能测试完成,误差:" + str(error_max))
    else:
        #tkinter.messagebox.showinfo(title='信息提示！', message='tan功能测试完成,误差不大于0.001!')
        content3.set("tan功能测试完成,误差:" + str(error_max))
    # return error_max
...
def test_cot(): #调用九组func.py进行测试
    ...
    if (error_max > 1e-3):
        # print("error_max:", error_max, "deg:", deg)
        #tkinter.messagebox.showwarning(title='出错了！', message='cot功能测试完成,误差大于0.001!')
        content4.set("cot功能测试完成,误差:" + str(error_max))
    else:
        #tkinter.messagebox.showinfo(title='信息提示！', message='cot功能测试完成,误差不大于0.001!')
        content4.set("cot功能测试完成,误差:" + str(error_max))
    # return error_max
...
content7=StringVar()
content8=StringVar()
e1 = Entry(root,  textvariable=content1,state='readonly',width=34).place(x=10,y=220)
e2 = Entry(root,  textvariable=content2,state='readonly',width=34).place(x=10,y=245)
e3 = Entry(root,  textvariable=content3,state='readonly',width=34).place(x=10,y=270)
e4 = Entry(root,  textvariable=content4,state='readonly',width=34).place(x=10,y=295)
e5 = Entry(root,  textvariable=content5,state='readonly',width=34).place(x=10,y=320)
e6 = Entry(root,  textvariable=content6,state='readonly',width=34).place(x=10,y=345)
e7 = Entry(root,  textvariable=content7,state='readonly',width=34).place(x=10,y=370)
e8 = Entry(root,  textvariable=content8,state='readonly',width=34).place(x=10,y=395)
